	...
	match index:
		...
		1:  # Enemy
			return _make_encounter("Corrupted Broodlings", 2200,
				["void_imp", "void_imp", "void_imp", "shadow_hound", "shadow_hound", "shadow_bolt"])
		2:  # Boss
			return _make_encounter("Imp Matriarch", 3000,
				["void_imp", "void_imp", "shadow_hound", "shadow_hound", "abyssal_brute", "shadow_bolt"])
		# -- Act 2: Abyss Dungeon --
		3:  # Enemy
			return _make_encounter("Abyss Cultist Patrol", 3200,
				["shadow_hound", "shadow_hound", "abyssal_brute", "abyssal_brute", "shadow_bolt"])
		4:  # Enemy
			return _make_encounter("Void Ritualist", 3600,
				["shadow_hound", "abyssal_brute", "abyssal_brute", "shadow_bolt", "shadow_bolt", "void_barrage"])
		5:  # Boss
			return _make_encounter("Corrupted Handler", 4400,
				["abyssal_brute", "abyssal_brute", "abyssal_brute", "shadow_bolt", "shadow_bolt", "void_barrage"])
		# -- Act 3: Void Rift World --
		6:  # Enemy
			return _make_encounter("Rift Stalker", 4200,
				["abyssal_brute", "abyssal_brute", "shadow_bolt", "shadow_bolt", "void_barrage"])
		7:  # Enemy
			return _make_encounter("Void Aberration", 4800,
				["abyssal_brute", "abyssal_brute", "abyssal_brute", "shadow_bolt", "void_barrage", "void_barrage"])
		8:  # Boss
			return _make_encounter("Void Herald", 6000,
				["abyssal_brute", "abyssal_brute", "abyssal_brute", "shadow_bolt", "shadow_bolt", "void_barrage", "void_barrage"])
		# -- Act 4: Void Castle --
		9:  # Enemy
		...
		12:  # Enemy
			return _make_encounter("Void Ritualist Prime", 6000,
				["abyssal_brute", "abyssal_brute", "shadow_bolt", "shadow_bolt", "shadow_bolt", "void_barrage", "void_barrage"])
		13:  # Elite
			return _make_encounter("Void Champion", 7000,
				["abyssal_brute", "abyssal_brute", "abyssal_brute", "shadow_bolt", "shadow_bolt", "shadow_bolt", "void_barrage", "void_barrage"])
		14:  # Final Boss
			return _make_encounter("Abyss Sovereign", 10000,
				["abyssal_brute", "abyssal_brute", "abyssal_brute", "abyssal_brute", "shadow_bolt", "shadow_bolt", "shadow_bolt", "void_barrage", "void_barrage"])
	return null
